...
select * from v_loadout
 where cmdr = 'Zoy' and UPPER(shipident) <> 'TBAG-Z'
;

SELECT cmdr, "current", ship_id, shiptype, shiptypel, shipname, star, value, Hot, xfer_cost, xfer_time
FROM v_stored_ships;

select * from v_ship_list vsl ;

drop view v_ship_modules;
